========================================================================
		ActiveX Control DLL : CUOCX
========================================================================

ControlWizard has created this project for your CUOCX ActiveX Control
...
that make up your CUOCX ActiveX Control DLL.
...
CuOcxCtl.h
	This file contains the declaration of the CCuOcxCtrl C++ class.

CuOcxCtl.cpp
	This file contains the implementation of the CCuOcxCtrl C++ class.

CuOcxPpg.h
	This file contains the declaration of the CCuOcxPropPage C++ class.

CuOcxPpg.cpp
	This file contains the implementation of the CCuOcxPropPage C++ class.

CuOcxCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CCuOcxCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file CuOcx.rc.
